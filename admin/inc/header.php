...
<?php
include '../config.php';
$qj=mysqli_query($con,"select * from admin where username='".$_SESSION['username']."' ");
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                       ...
                       <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="img/avatar-a.jpg" alt="user image" class="profile-pic" /></a>
                        ...
                        Hello,Admin  Mary-Cynthia
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="../admin/profile.php"><i class="ti-user"></i> Profile</a></li>
                                   
                                    <li><a href="../admin/logout.php" onclick="return confirm('Are sure you want to Logout?')"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
