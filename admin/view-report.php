...
$qk=mysqli_query($con,"select * from posts order by id desc");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">View Homicide Reports</a></li>
                                    ...
                                    <table id="myTable" class="table table-hover table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <td><a href="report-detail.php?id=<?php echo $r['id']?>" onClick="return confirm('Are you sure you want to view this report ?')"><i class="fa fa-eye"></i></a></td>
