...
$ok=mysqli_query($con,"select * from user where email='".$row_post['ipo']."' ");
$ipo=mysqli_fetch_assoc($ok);
?>
...
<div class="col-md-7">Reported by : <?php echo strtoupper($ipo['fname']); ?> (<?=$ipo['phone']?>)</div>
