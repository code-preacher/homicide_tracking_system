...
<div class="col-md-7">Reported by : Me</div>
...
echo "<img src='homicide_images/".$row_post['image']."' width='750' height='500'>";
} else {
echo "";
}
?>
...
echo "<audio controls><source src='homicide_audio/".$row_post['audio']."'></source></audio>";
} else {
echo "";
}
?>
...
echo "<video controls><source src='homicide_video/".$row_post['video']."'></source></audio>";
} else {
echo "";
}
?>
