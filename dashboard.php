...
<?php
include '../config.php';
$qt=mysqli_query($con,"select * from user where email='".$_SESSION['id']."' ");
$qr=mysqli_num_rows($qt);
$qd=mysqli_fetch_assoc($qt);


$qt21=mysqli_query($con,"select * from ongoing_posts where ipo='".$qd['email']."' ");
