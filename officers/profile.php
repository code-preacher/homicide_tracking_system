...
<?php
include '../config.php';
$x=mysqli_query($con,"select username,password from officers where service_no='".$_SESSION['service_no']."'");
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Change Credentials</a></li>
                                ...
                                <div class="basic-form">
                                    <form action="cpass.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-rounded" name="username"  required="required" value=<?php echo $xx['username'];  ?>  >
                                        </div>
                                        <div class="form-group">
