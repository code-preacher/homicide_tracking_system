...
<?php
include '../config.php';
$qj=mysqli_query($con,"select * from officers where service_no='".$_SESSION['service_no']."'");
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                       ...
                       <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="img/avatar-a.jpg" alt="user image" class="profile-pic" /></a>
                        ...
                        Hello,Officer  <?php echo $tr['officer'];  ?>   
                            <div class="dropdown-menu dropdown-menu-right animated zoomIn">
                                <ul class="dropdown-user">
                                    <li><a href="../officers/profile.php"><i class="ti-user"></i> Profile</a></li>
                                   
                                    <li><a href="../officers/logout.php" onclick="return confirm('Are sure you want to Logout?')"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
